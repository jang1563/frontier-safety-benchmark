...
The Frontier Uplift Observatory is organized around three layers: a \emph{taxonomy and item design layer} that structures evaluation content, a \emph{scoring and auditing layer} that measures mitigation effectiveness, and a \emph{release governance layer} that manages contamination risk.
