# Restricted Data Placeholder

This directory is intentionally empty in the public scaffold.

Purpose:

- reserve the path for restricted audit items
- make the public/restricted split visible in the repo
- avoid storing sensitive content in the public project scaffold
